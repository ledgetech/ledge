...
TEST_LEDGE_REDIS_SOCKET ?=unix://tmp/redis.sock
...
test: all
	...
	PATH=$(OPENRESTY_PREFIX)/nginx/sbin:$$PATH TEST_LEDGE_REDIS_DATABASE=$(TEST_LEDGE_REDIS_DATABASE) TEST_LEDGE_REDIS_SOCKET=$(TEST_LEDGE_REDIS_SOCKET) TEST_NGINX_NO_SHUFFLE=1 prove -I../test-nginx/lib	$(TEST_FILE)
